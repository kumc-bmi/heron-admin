...
public interface SystemAccessRecords {
	/**
	 * Turn a Ticket into a RepositoryUser, provided the ticket is from a
	 * recognized agent who signed the system access agreement.
	 * 
	 * @param who
	 * @return
	...
	/**
	 * Turn a Ticket into a Sponsor, provided the ticket is from a qualified
