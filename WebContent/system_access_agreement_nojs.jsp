...
<form id="frmSysAccess" action="/raven/SystemAccessNoJsServlet">
...
<input type="submit" name="agreementbtn" value="Accept"/> <input type="submit" name="agreementbtn" value="Decline"/>
<p></p>
