...
<p></p>
Access to other HERON data or use of HERON data for other purposes shall be permitted by KUMC only for qualified faculty and collaborating researchers specifically approved by the HERON Data Request Oversight Committee after submission of a project-specific information request, research proposal and executed data use agreement, in a format acceptable to Committee.  <br>
All forms required for access to the HERON system may be obtained from Division of Medical Informatics, Department of Biostatistics and should be submitted to the HERON Data Request Oversight Committee at least 7 days prior to the desired date of system access. 
<p></p>
...
<P></P>
3.	The University of Kansas Hospital Authority and Kansas University Physicians, Inc. are third-party beneficiaries of this Agreement and shall be entitled to enforce any obligation, responsibility or claim of KUMC pursuant to this Agreement.
<P></P>
4.	This Agreement may be amended or terminated at any time, with or without cause, by the HERON Executive Committee.
