...
def TrainingRecordsAdmin(acct, exempt_pid,
    ...
    FROM "CRS"
    WHERE "CRS"."strGroup" IN (:strGroup_1, :strGroup_2, :strGroup_3, :strGroup_4, :strGroup_5, :strGroup_6, :strGroup_7, :strGroup_8)
